...
export default function EmailBuilder() {
  ...
  const emailHTML = useMemo(() => {
    // Build vehicle grid rows in groups of 3
    const groups = [];
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;max-width:580px;background:#ffffff;">
  <tr>
    ...
    const btnStyle = `display:inline-block;background:${branding.btnBg};color:${branding.btnTextColor};padding:14px 30px;text-decoration:none;font-size:16px;line-height:16px;`;

    // Full HTML (600px table layout, email‑safe). Fonts/structure modeled from provided base.
...
<body style="background:${branding.brandBg};">
              ...
              <tr>
                <td width="70%" valign="top">
                  <table role="presentation" width="100%">
                    <tr>
                      <td style="font:12px/12px Arial,Helvetica,sans-serif;color:#0d0d0d;white-space:nowrap;text-align:center">
  ...
  return (
    <div className="p-6 max-w-[1200px] mx-auto space-y-6">
      ...
      <p className="text-sm text-muted-foreground">Brand‑correct, 600px table layout. Exports full HTML compatible with Gmail/Outlook. Built from your provided template structure.</p>

      <Tabs defaultValue="content" className="w-full">
        <TabsList>
          <TabsTrigger value="content">Content</TabsTrigger>
          <TabsTrigger value="branding">Brand & Layout</TabsTrigger>
          ...
          <Card className="mt-3"><CardContent className="space-y-6 pt-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="text-xs text-muted-foreground">Add up to 9 (renders 3 per row)</div>
              </div>
              <div className="space-y-3">
                {vehicles.map((v, i) => (
                  <VehicleRow
          ...
          <Card className="mt-3"><CardContent className="space-y-4 pt-4">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">3‑wide tiles built from your list</div>
              </div>
        ...
        <TabsContent value="preview">
          <Card className="mt-3"><CardContent className="space-y-4 pt-4">
            ...
            <details>
              <summary className="cursor-pointer text-sm text-muted-foreground">Show raw HTML</summary>
